...
import com.iqscaffold.userservice.registration.SignupRequest;
import com.iqscaffold.userservice.registration.UserRegistrationResponse;
...
/**
 * REST controller for authentication endpoints using Resource suffix convention. Handles user registration, login, token refresh, and logout operations.
 */
@RestController
...
public class AuthenticationRestResource {
  ...
  public AuthenticationRestResource(
