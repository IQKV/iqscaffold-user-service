...
import com.iqscaffold.userservice.tenancy.SystemLiquibaseInitializer;
 ...
 * 
 * <p>This configuration depends on SystemLiquibaseInitializer to ensure database migrations
 * are executed before JPA repositories and EntityManagerFactory are initialized.
 */
@Configuration
