...
/**
 * JWT Authentication Filter that extracts user context from JWT claims and sets it as the authentication principal.
 *
 * <p>This filter runs after Spring Security's OAuth2 Resource Server has validated the JWT token.
 * It extracts user information from JWT claims, creates a UserContext object, and replaces the
 * JwtAuthenticationToken with a UsernamePasswordAuthenticationToken that has UserContext as the principal.
 *
 * <h3>Responsibilities:</h3>
 * <ul>
 *   <li>Extract user context from JWT claims</li>
 *   <li>Set UserContext as authentication principal for @AuthenticationPrincipal</li>
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      if (authentication instanceof JwtAuthenticationToken jwtAuthToken) {
        ...
        // This allows @AuthenticationPrincipal UserContext to work
  ...
  private UserContext extractUserContext(Jwt jwt) {
    ...
    Set<String> permissions = extractAuthorities(jwt.getClaim(JwtClaimNames.PERMISSIONS));
    ...
    // Extract custom claims as a map
    @SuppressWarnings("unchecked")
    Map<String, Object> customClaims = (Map<String, Object>) jwt.getClaim("customClaims");
