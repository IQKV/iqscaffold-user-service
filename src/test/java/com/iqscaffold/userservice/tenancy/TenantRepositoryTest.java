...
class TenantRepositoryTest {
  ...
  static class TestConfig {
    ...
    @Bean
    com.iqscaffold.userservice.tenancy.TenantLiquibaseRunner liquibaseRunner() {
      return org.mockito.Mockito.mock(com.iqscaffold.userservice.tenancy.TenantLiquibaseRunner.class);
    }
